...
function Routes() {
	return <Router pageLoadingDelay={300}>
		<Set wrap={MainLayout}>
			<Route path="/color-schemes/new"
			page={NewColorSchemePage}
			name="newColorScheme" />
			<Route path="/color-schemes/{id}/edit"
			page={EditColorSchemePage}
			name="editColorScheme" />
			<Route path="/color-schemes/{id}"
			page={ColorSchemePage}
			name="colorScheme" />
			<Route path="/color-schemes"
