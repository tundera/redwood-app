...
function TeamForm(props) {
	...
	return <div className="rw-form-wrapper">
		<Form onSubmit={onSubmit} error={props.error}>
			...
			<TextField name="logoSlug"
			defaultValue={props.team?.logoSlug}
			className="rw-input"
			errorClassName="rw-input rw-input-error"
			validation={{required: true}} />
			<FieldError name="logoSlug" className="rw-field-error" />
			<Label name="wins"
			className="rw-label"
			errorClassName="rw-label rw-label-error">
				Wins
			</Label>
			<NumberField name="wins"
