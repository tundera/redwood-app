			...
			<tbody>
				{players.map((player) =>
					<tr key={player.id}>
						...
						<td>
							{timeTag(player.createdAt)}
						</td>
						<td>
							{timeTag(player.updatedAt)}
						</td>
						<td>
							{truncate(player.handle)}
						</td>
						<td>
							{truncate(player.name)}
						</td>
						<td>
							{truncate(player.slug)}
						</td>
						<td>
							{truncate(player.height)}
						</td>
						<td>
							{truncate(player.weight)}
						</td>
						<td>
							{truncate(player.number)}
						</td>
						<td>
							{truncate(player.position)}
						</td>
						<td>
							{truncate(player.teamId)}
						</td>
						<td>
							<nav className="rw-table-actions">
								...
								<Link to={routes.editPlayer({id: player.id})}
