...
const ColumnFeatures: React.FunctionComponent = () => {
	return <Flex bg={useColorModeValue("#F9FAFB", "gray.600")}
	p={20}
	w="auto"
	...
	alignItems="center">
		...
		shadow="xl">
			...
			<Feature title="Grow your platform&rsquo;s revenue"
			icon={<path strokeLinecap="round"
			strokeLinejoin="round"
			strokeWidth="2"
