...
function ColorSchemesList({colorSchemes}) {
			...
			<tbody>
				{colorSchemes.map((colorScheme) =>
					<tr key={colorScheme.id}>
						...
						<td>
							{truncate(colorScheme.primary)}
						</td>
						<td>
							{truncate(colorScheme.secondary)}
						</td>
						<td>
							{truncate(colorScheme.teamId)}
						</td>
						<td>
							<nav className="rw-table-actions">
								<Link to={routes.colorScheme({id: colorScheme.id})}
