			...
			<tbody>
				{teams.map((team) =>
					<tr key={team.id}>
						...
						<td>
							{timeTag(team.createdAt)}
						</td>
						<td>
							{timeTag(team.updatedAt)}
						</td>
						<td>
							{truncate(team.handle)}
						</td>
						<td>
							{truncate(team.name)}
						</td>
						...
						<td>
							{truncate(team.abbreviation)}
						</td>
						<td>
							{truncate(team.logo)}
						</td>
						<td>
							{truncate(team.logoSlug)}
						</td>
						<td>
							{truncate(team.wins)}
						</td>
						<td>
							{truncate(team.losses)}
						</td>
						<td>
							{truncate(team.winPercentage)}
						</td>
						<td>
							{truncate(team.conference)}
						</td>
						<td>
							{truncate(team.division)}
						</td>
						<td>
							{truncate(team.established)}
						</td>
						<td>
							<nav className="rw-table-actions">
								...
								<Link to={routes.editTeam({id: team.id})}
